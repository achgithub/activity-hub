-- Bulls and Cows Game Tables
-- Adds game state and guesses tables for bulls-and-cows mini-app
-- Supports both solo (1-player) and 2-player modes with dual-code simultaneous guessing

-- Games table for both solo and 2-player modes
