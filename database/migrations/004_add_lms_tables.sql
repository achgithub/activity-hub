-- Migration 004: LMS Manager Tables
-- Administration tool for running Last Man Standing competitions
-- Run on Pi: sudo -u postgres psql -d activity_hub -f database/migrations/004_add_lms_tables.sql
