#!/bin/bash
# PreToolUse Hook (All Tools): Logs and enforces rules for ALL tool operations
# This runs BEFORE every tool use (Read, Write, Edit, Bash, etc.)
# Exit 0 = allow, Exit 2 = block
#
# LEARNING MODE: This hook logs everything to help you build restrictions over time
# Review the log, then convert frequent violations to deny rules
#
# NOTE: Configured in settings.json as PreToolUse with "matcher": "*"
# NOT PermissionRequest (which only fires for permission dialogs)
